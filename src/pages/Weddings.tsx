...
export default function Weddings() {
  ...
  return (
    <div className="bg-[#FAF9F5] text-slate-charcoal pb-24 min-h-screen font-sans antialiased">
      ...
      <section className="relative min-h-[480px] flex items-center justify-center py-20 px-6 overflow-hidden border-t border-stone-200/20 bg-[#1E2229]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          {/* Elegant Hero-style Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#1E2229] via-black/15 to-[#1E2229]/40 z-10" />
        </div>
