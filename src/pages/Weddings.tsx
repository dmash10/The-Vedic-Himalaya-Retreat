...
export default function Weddings() {
  ...
  return (
    <div className="bg-[#FAF9F5] text-slate-charcoal pb-24 min-h-screen font-sans antialiased">
      ...
      {/* 6. WEDDING PACKAGES CTA SECTION */}
      <section className="relative min-h-[480px] flex items-center justify-center py-20 px-6 overflow-hidden border-t border-stone-200/20">
        {/* Background Image with Cover */}
        <div className="absolute inset-0 z-0">
          <img 
            src={weddingsCtaBgImage} 
            alt="Wedding Celebration Background" 
            className="w-full h-full object-cover object-center"
            referrerPolicy="no-referrer"
          />
          {/* Elegant Dark Emerald Overlay */}
          <div className="absolute inset-0 bg-[#0A1311]/80 mix-blend-multiply" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0A1311] via-transparent to-[#0A1311]/30" />
        </div>

        {/* Content Box */}
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-7 text-white">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-heading tracking-tight text-white leading-tight">
              {weddingsCtaTitle}
            </h2>
            <p className="text-xs md:text-sm text-white/70 max-w-md mx-auto font-sans leading-relaxed font-light">
              {weddingsCtaDesc}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto pt-2">
            ...
            <Link to={weddingsCtaBtnLink} className="w-full sm:w-auto">
              <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#C4A665] hover:bg-[#FAF9F5] text-black font-extrabold uppercase tracking-[0.18em] text-[10px] rounded-xl transition-all duration-300 shadow-lg cursor-pointer">
            ...
            <a 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-3.5 bg-[#25D366] hover:bg-[#20ba59] text-white font-extrabold uppercase tracking-[0.18em] text-[10px] rounded-xl transition-all duration-300 shadow-lg cursor-pointer border border-[#25D366]/10"
            >
          ...
          <p className="text-[9px] text-white/50 uppercase tracking-[0.2em] font-mono pt-4">
            {weddingsCtaFootnote}
          </p>
        </div>
      </section>
