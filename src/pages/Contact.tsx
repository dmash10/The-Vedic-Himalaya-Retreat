      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl">
        ...
        <header className="mb-20 text-center space-y-6 max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-heading font-medium tracking-tight text-slate-charcoal leading-[1.1]">
            {contactHeading} <br />
            <span className="italic font-serif font-normal text-[#1B4C44]">Sacred Arrival</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 max-w-4xl mx-auto items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 items-start group pt-6 border-t border-[#D8CBB8]/20">
                ...
                <div>
                  ...
                  <a href="#" className="text-xs font-bold text-slate-charcoal hover:text-[#1B4C44] transition-colors font-sans border-b border-[#D8CBB8] pb-0.5 mt-0.5 inline-block">
                     @thevedichimalayaretreat
                  </a>
                </div>
              </div>
          ...
          <div className="bg-[#0B1714] border border-[#D8CBB8]/20 shadow-2xl p-6 md:p-10 rounded-2xl relative overflow-hidden text-white min-h-[420px] flex flex-col justify-center">
             ...
             <AnimatePresence mode="wait">
               {!submitted ? (
                 ...
                 >
                   <h3 className="text-xl font-heading font-medium tracking-tight mb-6 relative z-10 text-white">Send an Inquiry</h3>
